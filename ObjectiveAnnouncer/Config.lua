...
local CHAT, SAY, PARTY, RAID, GUILD, OFFICER, CHANNEL = _G.CHAT, _G.CHAT_MSG_SAY, _G.CHAT_MSG_PARTY, _G.CHAT_MSG_RAID, _G.CHAT_MSG_GUILD, _G.CHAT_MSG_OFFICER, _G.CHANNEL
	...
	args = {
		options = {
			...
			args={
				...
				announceChannels = {
				--	inline = true,
					name = "|TInterface\\Icons\\Ability_warrior_rallyingcry:18|t "..L["annchannels"],
...
function ObjAnn:oacommandHandler(input)
	...
	elseif k then	-- If user typed something invalid, show help.
	   ObjAnn:Print(helpText)		
		...
		if ACD.OpenFrames[NAME] then
			...
			--ACD:SetDefaultSize(NAME, 800,600)
			ACD:Open(NAME)
		end
	...
	--[[ LibSharedMedia ]]--
LSM:Register("sound", "PVPFlagCapturedHorde","Interface\\Addons\\ObjectiveAnnouncer\\Sounds\\PVPFlagCapturedHordeMono.ogg")
LSM:Register("sound", "PVPFlagCaptured", "Interface\\Addons\\ObjectiveAnnouncer\\Sounds\\PVPFlagCapturedMono.ogg")
LSM:Register("sound", "GM ChatWarning", "Interface\\Addons\\ObjectiveAnnouncer\\Sounds\\GM_ChatWarning.ogg")
